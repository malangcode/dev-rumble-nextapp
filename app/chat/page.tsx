...
import { HiOutlinePaperAirplane, HiOutlineChatAlt2, HiX } from "react-icons/hi";
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-23 right-6 w-80 sm:w-96 h-[500px] bg-white/20 backdrop-blur-xl rounded-2xl shadow-xl flex flex-col overflow-hidden border border-white/30"
          >
            {/* Header */}
