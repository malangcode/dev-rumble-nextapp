    ...
    <div className="py-6 animate-pulse">
      ...
      <div className="space-y-4">
        {[1, 2].map((_, i) => (
          <div
            key={i}
            className="flex flex-wrap md:flex-nowrap items-center justify-between bg-gray-100 rounded-lg p-4 gap-4"
          >
            ...
            <div className="flex items-center space-x-4 flex-1 min-w-[200px]">
              ...
              <div>
                <div className="h-5 w-32 md:w-48 bg-gray-300 rounded mb-2"></div>
                <div className="h-4 w-16 md:w-24 bg-gray-300 rounded"></div>
              </div>
            </div>
